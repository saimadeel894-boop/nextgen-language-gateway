...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group pulse-ring fixed right-4 bottom-4 z-50 isolate flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 shadow-lift transition-all duration-300 hover:-translate-y-1 hover:brightness-105 sm:right-6 sm:bottom-6"
    >
      ...
      <span className="hidden text-sm font-semibold text-white sm:inline">Chat on WhatsApp</span>
    </a>
  );
}
